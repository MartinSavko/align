...
def loadResults(fileName='aperture_scan_Thu_Jul_11_03:33:22_2013.pck'):
    f = open(fileName)
...
def plot_surface_wire(X, Y, Z, filename='resultFigure.png', stride=1):
    ...
    surf = ax.plot_surface(X, Y, Z, rstride=stride, cstride=stride, cmap=cm.coolwarm, linewidth=0, antialiased=False)
...
def main():
    ...
    parser.add_option('-f', '--filename', type = str, help = 'File with the scan results')
